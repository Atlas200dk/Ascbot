...
*/
#ifndef NETLINK_STREAMMANAGER_H_  // [
#define NETLINK_STREAMMANAGER_H_
#endif  // NETLINK_STREAMMANAGER_H_
#pragma once
...
protected:
    ...
    explicit StreamManager(std::streambuf* _streamBuffer) : streamBuffer(_streamBuffer) { }
};

//! Used to serialize elements into a std::streambuf
class Serializer : public StreamManager {
//!< Typedef of callback to get the next element to be serialized
...
public:
    ...
    */
    explicit Serializer(std::streambuf* _streamBuffer) : StreamManager(_streamBuffer) { }
...
//!< Typedef of callback to return deserialized elements
...
public:
		 ...
		 */
        explicit Deserializer(std::streambuf* _streamBuffer): StreamManager(_streamBuffer) { }
