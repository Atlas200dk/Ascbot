...
class CollisionInferenceEngine : public Engine {
public:
...
private:
    ...
    std::vector<std::map<uint8_t*, int>>
        predict_input_data_;  // map for storing data from argX, first:buffer, second:buffer's size
                              /**
