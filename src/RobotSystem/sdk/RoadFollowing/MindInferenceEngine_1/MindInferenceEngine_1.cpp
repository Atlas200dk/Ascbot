...
* @brief: destructor
*/
RFMindInferenceEngine::~RFMindInferenceEngine() {
...
*/
HIAI_StatusT RFMindInferenceEngine::Init(const hiai::AIConfig& config,
...
*/
void RFMindInferenceEngine::HandleExceptions(std::string error_msg) {
...
*/
HIAI_StatusT RFMindInferenceEngine::SendSentinelImage() {
    ...
    do {
        ...
        if (HIAI_OK != hiai_ret) {
            ...
            HIAI_ENGINE_LOG(HIAI_IDE_ERROR, "[MindInferenceEngine_1] SendData error[%d], break.",
                            hiai_ret);
            break;
        }
...
* @return: HIAI_StatusT
*/
HIAI_StatusT RFMindInferenceEngine::PrepareInputBuffer(uint8_t* input_buffer,
...
* @return: HIAI_StatusT
*/
HIAI_StatusT RFMindInferenceEngine::PrepareInforInput(
...
* @return: HIAI_StatusT
*/
HIAI_StatusT RFMindInferenceEngine::Predict() {
    ...
    // int64_t start = getCurrentTime_ms();
    ...
    // HIAI_ENGINE_LOG(HIAI_IDE_INFO, "[MindInferenceEngine_1] ai_model_manager_->Process end!");
    // int64_t end = getCurrentTime_ms();
    // int64_t diff = end - start;
    // std::cout << "inference time:" << diff << ", end:" << end << ", start:" << start <<
    // std::endl;
    if (hiai::SUCCESS != ret) {
...
* @return: HIAI_StatusT
*/
HIAI_StatusT RFMindInferenceEngine::SetOutputStruct(const int batch_begin) {
...
*/
void RFMindInferenceEngine::SendResult() {
    HIAI_StatusT hiai_ret = HIAI_OK;
    do {
        hiai_ret = SendData(0, "EngineTransT", std::static_pointer_cast<void>(tran_data));
...
* @in: index of the begin of this batch
*/
void RFMindInferenceEngine::HandleModelBatchFailure(const int batch_begin, const int image_number) {
...
*/
HIAI_IMPL_ENGINE_PROCESS("RFMindInferenceEngine", RFMindInferenceEngine, INPUT_SIZE) {
...
#if INPUT_ARGS_SIZE_EQUAL(3)
    DEFINE_MULTI_INPUT_ARGS_POP(3);
#endif

#if INPUT_ARGS_SIZE_EQUAL(4)
    DEFINE_MULTI_INPUT_ARGS_POP(4);
#endif

#if INPUT_ARGS_SIZE_EQUAL(5)
    DEFINE_MULTI_INPUT_ARGS_POP(5);
#endif

#if INPUT_ARGS_SIZE_EQUAL(6)
    DEFINE_MULTI_INPUT_ARGS_POP(6);
#endif

#if INPUT_ARGS_SIZE_EQUAL(7)
    DEFINE_MULTI_INPUT_ARGS_POP(7);
#endif

#if INPUT_ARGS_SIZE_EQUAL(8)
    DEFINE_MULTI_INPUT_ARGS_POP(8);
#endif

#if INPUT_ARGS_SIZE_EQUAL(9)
    DEFINE_MULTI_INPUT_ARGS_POP(9);
#endif

#if INPUT_ARGS_SIZE_EQUAL(10)
