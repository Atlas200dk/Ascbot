...
class ObjectPostProcess : public Engine {
private:
...
private:
    ...
    * @[in]: out_bbox: struct of the detected content, including bbox coordinates, predicted
    ...
    */
    ...
    /**
    * @brief: reset the cropinfo to make sure the output bbox coordinates are always relative to
    * the original image
