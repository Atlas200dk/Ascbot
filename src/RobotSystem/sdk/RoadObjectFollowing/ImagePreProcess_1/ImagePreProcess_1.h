...
typedef struct DvppConfig {
    ...
    bool v_before_u;  // output sp format, uv order. whether v is before u, while op_type is set to
                      // 1
...
// Define RoadObjectPreProcess
class RoadObjectPreProcess : public Engine {
private:
