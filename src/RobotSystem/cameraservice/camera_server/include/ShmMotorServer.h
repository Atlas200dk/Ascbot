#ifndef _SHMMOTORSERVER_H_
#define _SHMMOTORSERVER_H_
...
typedef struct motor_status {
  unsigned int init;
  int roadfollowingSwitch;
  int collisionSwitch;
  int objectDetectionSwitch;
  int roadobjectDetectionSwitch;
