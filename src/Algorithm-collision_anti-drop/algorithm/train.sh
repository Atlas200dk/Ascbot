...
~/caffe/build/tools/caffe train --solver=./Resnet18_class_solver.prototxt  --gpu 0,1 --weights=./Resnet18_table_weights/2+2_table_nj_iter_50000.caffemodel 2>&1 | tee ./caffe_log.txt
